...
function MeterChart() {
    ...
    useEffect(() => {
        Highcharts.chart('meter-chart', {
            ...
            series: [{
              name: 'Current Period',
              borderColor:  Highcharts.Color(Highcharts.getOptions().colors[0]).setOpacity(0.3).get(),
              data: [{
              ...
              borderColor:  Highcharts.Color(Highcharts.getOptions().colors[1]).setOpacity(0.3).get(),
              data: [{
